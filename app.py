...
def remove_repeated_text(text):
    """Remove repeated sentences or phrases in the response."""
...
def answer_question(vectorstore, query):
    ...
    cleaned_response = remove_repeated_text(response["result"])
    
    return cleaned_response


def main():
    st.title(" AI search Assistant Powered by Vector search")
